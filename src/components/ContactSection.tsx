          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground">Jeronimo Costa</h4>
                      <p className="text-muted-foreground">+54 341 540 3540</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">jeronimocp@ultracore.com.ar</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">www.ultracore.com.ar</p>
                    </div>
                  </div>
                </div>
            ...
            <Card className="bg-gradient-card border-border shadow-card">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold text-foreground mb-4">¿Necesitas una solución personalizada?</h3>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Agenda una reunión gratuita para analizar tus necesidades y descubrir cómo podemos impulsar el crecimiento de tu empresa.
                </p>
                ...
                <div className="mt-8 p-4 bg-tech-blue/10 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    <span className="font-semibold text-tech-blue">Respuesta garantizada</span> en menos de 24 horas
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="text-center">
            <div className="inline-flex items-center space-x-4 p-6 bg-gradient-card rounded-lg border border-border shadow-card">
              <div className="text-left">
                <h4 className="font-semibold text-foreground">¿Listo para comenzar?</h4>
                <p className="text-sm text-muted-foreground">Tu transformación digital comienza con una conversación</p>
              </div>
